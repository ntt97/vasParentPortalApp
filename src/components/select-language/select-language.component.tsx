  ...
  return (
    <ViewVertical style={[styles.containerLanguage, style]}>
      ...
      <RNPickerSelect
        ...
        placeholder={{}}
        Icon={() => {
          return <Image source={props.whiteArrow ? DOWN_ARROW_WHITE : DOWN_ARROW_BLACK} style={styles.arrowDown} />;
        }}
        style={
          {
            inputIOS: { ...pickerSelectStyles.inputIOS, ...props.pickerStyle?.inputIOS },
            inputAndroid: { ...pickerSelectStyles.inputAndroid, ...props.pickerStyle?.inputAndroid },
          }
        }
